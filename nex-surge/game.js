...
let totalPoints = parseInt((() => { const val = localStorage.getItem("totalScore"); console.log("[LOAD] totalScore:", val); return val; })() || "0");
...
window.addEventListener("DOMContentLoaded", () => {
  const saved = (() => { const val = localStorage.getItem("totalScore"); console.log("[LOAD] totalScore:", val); return val; })();
